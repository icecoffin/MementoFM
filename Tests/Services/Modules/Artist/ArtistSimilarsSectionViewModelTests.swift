...
class ArtistSimilarsSectionViewModelTests: XCTestCase {
  ...
  func testCurrentTabViewModelAfterInit() {
    ...
    let viewModel = ArtistSimilarsSectionViewModel(artist: artist, tabViewModelFactory: tabViewModelFactory, dependencies: dependencies)
  ...
  func testSelectArtistDelegateMethodIsCalled() {
    ...
    let tabViewModel = SimilarsSectionTabViewModel(artist: artist,
                                                   requestStrategy: SimilarArtistsLocalRequestStrategy(dependencies: dependencies),
