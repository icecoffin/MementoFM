...
final class ArtistServiceTests: XCTestCase {
    ...
    private var topTagsCalculator: MockArtistTopTagsCalculator!
    ...
    override func setUp() {
        ...
        topTagsCalculator = MockArtistTopTagsCalculator()
        scheduler = .immediate
    }

    override func tearDown() {
        persistentStore = nil
        topTagsCalculator = nil
        scheduler = nil
    ...
    func test_getLibrary_emitsLibraryPages() {
        ...
        let artistService = makeArtistService(repository: repository)
    ...
    func test_saveArtists_callsPersistentStore() {
        let artistService = makeArtistService(repository: StubArtistEmptyRepository())
    ...
    func test_calculateTopTagsForAllArtists_callsCalculatorForEachArtist_andSavesArtists() {
        ...
        _ = artistService.calculateTopTagsForAllArtists(ignoredTags: [])
            .sink(receiveCompletion: { _ in }, receiveValue: { })

        expect(self.topTagsCalculator.numberOfCalculateTopTagsCalled) == artists.count
    ...
    func test_calculateTopTagsForArtist_callsCalculatorOnce_andSavesArtist() {
        ...
        _ = artistService.calculateTopTags(for: artist, ignoredTags: [])

        expect(self.topTagsCalculator.numberOfCalculateTopTagsCalled) == 1
    ...
    private func makeArtistService(
        repository: ArtistRepository
    ) -> ArtistService {
        ArtistService(
            persistentStore: persistentStore,
            repository: repository,
            topTagsCalculator: topTagsCalculator,
